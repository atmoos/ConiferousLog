...
{
	/// <summary>Formats raw log messages for <see cref="SharpLogging.ISink">sinks</see>.</summary>
	public interface IMessageFormatter
	{
		DateTime TimeStamp { get; }
		String Format(Exception e);
		String Format<TFirst>(String textFormat, TFirst first);
		String Format<TFirst, TSecond>(String textFormat, TFirst first, TSecond second);
		String Format<TFirst, TSecond, TThird>(String textFormat, TFirst first, TSecond second, TThird third);
		String Format(String textFormat, params Object[] parameters);
	}
}
