...
{
	public sealed class Warning : Level
	{
		public Warning(ISink sink, IMessageFormatter formatter)
			: base(LogLevel.Warning, sink, formatter)
		{
		}

		public Warning(ISink sink)
			: base(LogLevel.Warning, sink)
		{
		}
